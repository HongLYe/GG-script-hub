...
local CorrectKey = "Yukio-SI21DAC-586FGEAG4H2829"

local KeyGui = Instance.new("ScreenGui")
KeyGui.Name = "YukioKeySystem"
KeyGui.Parent = game:GetService("CoreGui")

local MainKey = Instance.new("Frame")
MainKey.Parent = KeyGui
MainKey.Size = UDim2.new(0, 340, 0, 190)
MainKey.Position = UDim2.new(0.5, -170, 0.5, -95)
MainKey.BackgroundColor3 = Color3.fromRGB(8,8,8)
MainKey.BorderSizePixel = 0

Instance.new("UICorner", MainKey).CornerRadius = UDim.new(0,18)

local Gradient = Instance.new("UIGradient")
Gradient.Parent = MainKey
...
KeyBox.Parent = MainKey
KeyBox.Size = UDim2.new(0,280,0,42)
KeyBox.Position = UDim2.new(0.5,-140,0.5,-10)
...
Unlock.Parent = MainKey
Unlock.Size = UDim2.new(0,130,0,38)
Unlock.Position = UDim2.new(0,30,1,-55)
Unlock.BackgroundColor3 = Color3.fromRGB(120,0,0)
Unlock.Text = "Unlock"
...
local UnlockGradient = Instance.new("UIGradient")
UnlockGradient.Parent = Unlock
UnlockGradient.Color = ColorSequence.new{
...
GetKey.Parent = MainKey
GetKey.Size = UDim2.new(0,130,0,38)
GetKey.Position = UDim2.new(1,-160,1,-55)
...
GetStroke.Color = Color3.fromRGB(255,0,0)

local Allowed = false

GetKey.MouseButton1Click:Connect(function()
	setclipboard("https://discord.gg/baQzCUVS")
	GetKey.Text = "Copied!"
	task.wait(1)
	GetKey.Text = "Get Key"
end)
...
local Window = Rayfield:CreateWindow({
    ...
    NotificationActionsBackground = Color3.fromRGB(35,0,0),
    ...
    ElementBackgroundHover = Color3.fromRGB(30,0,0),

    SecondaryElementBackground = Color3.fromRGB(18,18,18),
    ElementStroke = Color3.fromRGB(255,0,0),
    SecondaryElementStroke = Color3.fromRGB(120,0,0),

    SliderBackground = Color3.fromRGB(50,0,0),
